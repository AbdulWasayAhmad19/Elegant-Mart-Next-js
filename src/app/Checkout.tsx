...
export default function Checkout() {
  ...
  return (
    <main className="container mx-auto px-4 md:px-10 py-8 my-14">
      <h2 className="text-3xl font-bold mb-8 text-center text-black">Checkout</h2>

      <div className="flex flex-col md:flex-row gap-8">
        {/* LEFT: Billing + Shipping Info */}
        <div className="flex-1 bg-white p-6 rounded-lg shadow-md text-black">
        ...
        <div className="md:w-1/3">
          <div className="bg-white p-6 rounded-lg shadow-md sticky top-6 text-black">
